  ...
  return (
    <div ref={sectionRef} className="relative flex items-center justify-center" style={{ height: '420px' }}>
      ...
      <div style={{ perspective: '900px', width: '340px', height: '380px', position: 'relative' }}>
        {/* Spine */}
        <div className="absolute left-1/2 -translate-x-1/2 bottom-0 rounded-sm" style={{
          width: '18px', height: '340px',
          background: 'linear-gradient(to bottom, #d4a843, #a07830)',
          zIndex: 10, boxShadow: '0 0 20px rgba(212,168,67,0.4)',
        }} />

        {/* LEFT PAGE */}
        <div style={{
          position: 'absolute', left: 'calc(50% - 9px)', bottom: 0,
          width: '155px', height: '340px',
          transformOrigin: 'right bottom',
          transform: `rotateY(${leftDeg}deg)`,
          transformStyle: 'preserve-3d',
          transition: 'transform 0.05s linear', zIndex: 5,
        }}>
          <div style={{
            position: 'absolute', inset: 0, background: '#fafaf8',
            borderRadius: '4px 0 0 4px', border: '1px solid #e0ddd5',
            padding: '20px 16px 20px 20px', backfaceVisibility: 'hidden',
          ...
          <div style={{
            position: 'absolute', inset: 0, background: '#f5f3ee',
        ...
        {/* RIGHT PAGE */}
        <div style={{
          position: 'absolute', right: 'calc(50% - 9px)', bottom: 0,
          width: '155px', height: '340px',
          ...
          <div style={{
            position: 'absolute', inset: 0, background: '#fafaf8',
            borderRadius: '0 4px 4px 0', border: '1px solid #e0ddd5',
            padding: '20px 20px 20px 16px', backfaceVisibility: 'hidden',
            boxShadow: '4px 0 20px rgba(0,0,0,0.3)', overflow: 'hidden',
          }}>
            <div style={{ opacity }} className="flex flex-col gap-2">
              <div className="h-2 rounded bg-gray-200" style={{ width: '80%' }} />
          ...
          <div style={{
            position: 'absolute', inset: 0, background: '#f5f3ee',
            borderRadius: '0 4px 4px 0', backfaceVisibility: 'hidden',
            transform: 'rotateY(180deg)',
          }} />
        </div>
      </div>
    ...
    <section id="features" ref={ref} className="py-28 bg-bg-primary relative border-t border-border/50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className={`text-center mb-14 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <span className="inline-block text-[11px] font-mono tracking-[0.25em] uppercase mb-4" style={{ color: 'var(--accent)' }}>
            Why ApexDocs
          </span>
        ...
        {/* Tabs — pure inline style switching, no pixel math */}
          ...
          {filtered.map((f, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-2xl"
                style={{ background: 'radial-gradient(circle at 50% 0%, rgba(212,168,67,0.09) 0%, transparent 70%)' }} />
              ...
              <h3 className="font-sans font-bold text-base text-text-primary mb-2 group-hover:text-accent transition-colors duration-200">
                {f.title}
              </h3>
  ...
  return (
    <div className="bg-bg-primary min-h-screen page-root overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-[55%_45%] gap-12 items-center w-full z-10">
          <div className="flex flex-col items-start pt-12 md:pt-0">
            ...
            <p className="animate-in delay-4 text-lg font-sans mb-10 max-w-lg leading-relaxed" style={{ color: 'var(--text-muted)' }}>
              Craft stunning resumes, invoices, reports and proposals.<br />
              Write once, export as a beautiful PDF instantly.
            </p>
      ...
      <section className="py-24 relative overflow-hidden border-t border-border/40">
        <div className="max-w-5xl mx-auto px-6">
          <div className="scroll-reveal text-center mb-16">
            ...
            <p className="font-sans text-lg max-w-xl mx-auto" style={{ color: 'var(--text-muted)' }}>From blank page to polished PDF — scroll to see it unfold.</p>
          </div>
              ...
              <div key={s.n} className="scroll-reveal relative z-10 flex flex-col items-center text-center" style={{ transitionDelay: `${i * 150}ms` }}>
                <div className="w-16 h-16 rounded-full flex items-center justify-center mb-6 relative"
                  ...
                  <div className="absolute inset-0 rounded-full"
                    style={{ background: 'rgba(212,168,67,0.15)', animation: `ping 2s ease-in-out infinite`, animationDelay: `${i * 300}ms` }} />
      ...
      <section className="py-24 border-y overflow-hidden" style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border)' }}>
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="mb-12 scroll-reveal flex items-end justify-between">
            ...
            <Link to="/templates" className="hidden md:flex items-center gap-2 text-sm font-medium transition-colors hover:text-accent" style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="flex gap-6 overflow-x-auto pb-8 pt-4 snap-x" style={{ scrollbarWidth: 'none' }}>
            {templates.slice(0, 7).map((template, idx) => {
              ...
              return (
                <div key={template.id} className="snap-center shrink-0 w-[260px] group relative scroll-reveal" style={{ transitionDelay: `${idx * 80}ms` }}>
                  <div
                    className="h-[300px] rounded-xl shadow-xl border border-gray-200 p-6 overflow-hidden transition-all duration-500 group-hover:shadow-2xl relative"
                    style={{ background: '#fafaf8', transform: `rotate(${rots[idx]}deg)`, transitionProperty: 'transform, box-shadow' }}
                    onMouseEnter={e => e.currentTarget.style.transform = 'rotate(0deg)'}
                    onMouseLeave={e => e.currentTarget.style.transform = `rotate(${rots[idx]}deg)`}
                  >
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center rounded-xl"
                      ...
                      <Link to="/templates"
                        className="px-5 py-2 rounded-lg text-sm font-bold translate-y-3 group-hover:translate-y-0 transition-transform duration-300"
      ...
      <section className="py-28 px-6">
        <div className="max-w-5xl mx-auto rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden scroll-reveal"
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: 'var(--text-muted)' }}>
              The modern way to write, design, and share markdown documents — beautifully.
            </p>
          </div>
          <div className="flex gap-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              {/* Privacy — opens a simple modal overlay */}
              <button
                onClick={() => document.getElementById('privacy-modal').showModal()}
                className="text-sm transition-colors hover:text-accent text-left"
      ...
      <dialog
        id="privacy-modal"
        className="rounded-2xl border border-border p-0 max-w-lg w-full mx-auto backdrop:bg-black/60 backdrop:backdrop-blur-sm"
        style={{ background: 'var(--bg-card)', color: 'var(--text-primary)' }}
        onClick={e => { if (e.target === e.currentTarget) e.currentTarget.close(); }}
      >
        <div className="p-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-serif text-2xl text-text-primary">Privacy Policy</h2>
            <button
              onClick={() => document.getElementById('privacy-modal').close()}
              className="w-8 h-8 rounded-full flex items-center justify-center transition-colors hover:bg-bg-elevated text-text-muted hover:text-text-primary text-xl leading-none"
            >
              ×
            </button>
          </div>
          <div className="flex flex-col gap-5 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            <div>
              <h3 className="font-bold text-text-primary mb-1">Data we collect</h3>
              <p>When you create an account, we store your name, email address, and the documents you create. Guest users' content is stored locally in your browser only.</p>
            </div>
            <div>
              <h3 className="font-bold text-text-primary mb-1">How we use it</h3>
              <p>Your data is used solely to provide the ApexDocs service — syncing documents across your devices and enabling sharing features. We do not sell your data to third parties.</p>
            </div>
            <div>
              <h3 className="font-bold text-text-primary mb-1">Third-party services</h3>
              <p>We use Firebase (Google) for authentication and database storage. Their privacy policy applies to data processed through their infrastructure.</p>
            </div>
            <div>
              <h3 className="font-bold text-text-primary mb-1">Your rights</h3>
              <p>You can delete your account and all associated data at any time. Documents shared via public links can be unshared from the editor.</p>
            </div>
            <div>
              <h3 className="font-bold text-text-primary mb-1">Contact</h3>
              <p>Questions? Reach us via the GitHub repository linked in the footer.</p>
            </div>
          </div>
          <button
            onClick={() => document.getElementById('privacy-modal').close()}
            className="mt-8 w-full py-3 rounded-xl font-medium text-sm transition-all primary-gold-btn"
          >
            Got it
          </button>
        </div>
